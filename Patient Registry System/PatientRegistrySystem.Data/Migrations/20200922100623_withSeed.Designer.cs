...
namespace PatientRegistrySystem.Data.Migrations
{
    ...
    [Migration("20200922100623_withSeed")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PatientRegistrySystem.Domain.Entities.Company", b =>
                {
            ...
            modelBuilder.Entity("PatientRegistrySystem.Domain.Entities.Doctor", b =>
                {
            ...
            modelBuilder.Entity("PatientRegistrySystem.Domain.Entities.Employee", b =>
                {
            ...
            modelBuilder.Entity("PatientRegistrySystem.Domain.Entities.Medicine", b =>
                {
            ...
            modelBuilder.Entity("PatientRegistrySystem.Domain.Entities.Prescription", b =>
                {
                    b.Property<int>("PrescriptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PatientRegistrySystem.Domain.Entities.Record", b =>
                {
            ...
            modelBuilder.Entity("PatientRegistrySystem.Domain.Entities.Role", b =>
                {
            ...
            modelBuilder.Entity("PatientRegistrySystem.Domain.Entities.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("PatientRegistrySystem.Domain.Entities.UserRole", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PatientRegistrySystem.Domain.Entities.Doctor", b =>
                {
                    b.HasOne("PatientRegistrySystem.Domain.Entities.User", "User")
                        .WithMany("Doctor")
            ...
            modelBuilder.Entity("PatientRegistrySystem.Domain.Entities.Employee", b =>
                {
                    b.HasOne("PatientRegistrySystem.Domain.Entities.Doctor", "Doctor")
                        .WithMany()
            ...
            modelBuilder.Entity("PatientRegistrySystem.Domain.Entities.Medicine", b =>
                {
                    b.HasOne("PatientRegistrySystem.Domain.Entities.Company", "Company")
                        .WithMany("Medicine")
                        .HasForeignKey("CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PatientRegistrySystem.Domain.Entities.Prescription", "Prescription")
                        .WithMany("Medicines")
            ...
            modelBuilder.Entity("PatientRegistrySystem.Domain.Entities.Record", b =>
                {
                    b.HasOne("PatientRegistrySystem.Domain.Entities.Employee", "Employee")
                        .WithMany("Record")
            ...
            modelBuilder.Entity("PatientRegistrySystem.Domain.Entities.UserRole", b =>
                {
                    b.HasOne("PatientRegistrySystem.Domain.Entities.Role", "Role")
                        .WithMany("UserRole")
